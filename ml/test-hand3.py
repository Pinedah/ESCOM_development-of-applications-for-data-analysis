    ...
    while cap.isOpened():
        ...
        if results.multi_hand_landmarks:
            ...
            if len(results.multi_hand_landmarks) == 2:
                ...
                # Condiciones para detectar el gesto (indices y pulgares juntos)
                if (abs(index1.x - index2.x) < 0.1 and abs(index1.y - index2.y) < 0.1 
                and abs(thumb1.x - thumb2.x) < 0.1 and abs(thumb1.y - thumb2.y) < 0.1 
                and abs(index1.x - thumb1.x) < 0.15 and abs(index1.y - thumb1.y) < 0.15):
